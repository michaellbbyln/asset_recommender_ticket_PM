...
# Link QR WhatsApp
wa_link = "https://wa.me/qr/BNTZIWELSGNGD1"
...
# tampilkan QR WhatsApp lebih dulu
st.write("📱 Jika ada pengajuan aset baru, silakan langsung hubungi IT P&G (Adi Novianto) via WhatsApp dengan scan QR berikut:")
st.image(buf.getvalue(), caption="QR Code WhatsApp", width=200) 

# lalu instruksi isi form
st.info(
    "Setelah itu, jangan lupa juga untuk mengisi form berikut:\n\n"
